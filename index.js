...
var _react = _interopRequireWildcard(__webpack_require__(15));

var _axios = _interopRequireDefault(__webpack_require__(12));
...
function (_Component) {
  ...
  function DataTable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchField", function () {
      return _react["default"].createElement("form", {
        ...
        type: "button",
        onClick: _this.searcButtonOnClick
      }, " Go ")));
    });
  ...
  _createClass(DataTable, [{
    ...
    value: function fetchEntities() {
      ...
      var fetchUrl = "".concat(this.props.url, "?term=").concat(this.state.search_term, "&page=").concat(this.state.current_page, "&column=").concat(this.state.sorted_column, "&order=").concat(this.state.order, "&per_page=").concat(this.state.entities.per_page);
    ...
    value: function tableHeads() {
      ...
      if (this.props.actions) {
        ...
        var _actionCol = _react["default"].createElement("th", {
          ...
          key: _name,
          onClick: function onClick() {
            return _this5.sortByColumn(_name);
          }
    ...
    key: "getCellOnClickFunction",
    value: function getCellOnClickFunction(columnName) {}
  }, {
    ...
    value: function pageList() {
      ...
      return this.pagesNumbers().map(function (page) {
        return _react["default"].createElement("li", {
          className: page === _this8.state.entities.current_page ? 'page-item active' : 'page-item',
          key: page
        }, _react["default"].createElement("button", {
          className: "page-link",
          onClick: function onClick() {
    ...
    value: function render() {
      ...
      }, this.searchField(), _react["default"].createElement("table", {
        className: "table table-bordered"
      }, _react["default"].createElement("thead", null, _react["default"].createElement("tr", null, this.tableHeads())), _react["default"].createElement("tbody", null, this.entityList())), this.state.entities.data && this.state.entities.data.length > 0 && _react["default"].createElement("nav", null, _react["default"].createElement("ul", {
      ...
      }, "Previous")), this.pageList(), _react["default"].createElement("li", {
        className: "page-item"
      }, _react["default"].createElement("button", {
        className: "page-link",
